...
export class ManagementComponent implements OnInit {
  ...
  getOverlappingItemString(item: OverlapItem):string {
    ...
    const poule1 = `${item.poule1.categorieValue} ${item.poule1.nummer} (${tijdstip1}, ${item.poule1.speellocatie.naam})`
    const poule2 = `${item.poule2.categorieValue} ${item.poule2.nummer} (${tijdstip2}, ${item.poule2.speellocatie.naam})`

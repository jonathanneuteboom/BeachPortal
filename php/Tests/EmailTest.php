...
final class EmailTest extends TestCase
{
    ...
    {
        $titel = 'Beachprogramma Sunday 13 December 2020';
...
De tegenstander (Eerste Speler, Tweede Speler)<br>
<br>
...
<br>
        ...
        $this->assertEquals($email->titel, $titel);
        $this->assertEquals($email->body, $body);
